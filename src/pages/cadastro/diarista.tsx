        ...
        <>
            ...
            {step === 2 && (
                <PageTitle
                    ...
                    subtitle={
                        <span>
                            Você poderá escolher aceitar ou não um serviço.
                        ...
                        <FormProvider {...userForm}>
                            ...
                            >
                                ...
                                <Typography sx={{ fontWeight: 'bold' }}>
                                    Hora da selfie! Envie uma selfie segurando o
                                    documento
                                </Typography>
                                <Typography sx={{ pb: 2 }}>
                                    Para a sua segurança, todos os profissionais
                                    e clientes precisam enviar
                                </Typography>
                                <PictureForm />
                                <Typography
                                    sx={{ pt: 1, pb: 5 }}
